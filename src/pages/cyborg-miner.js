      ...
      <section className="common-section miner-hero-section flow-hidden">
        <div className="container">
          <div className="miner-wrap d-flex a-center">
            ...
            <div className="d-right">
              <div className="miner-right">
                <motion.h1
                  viewport={{ once: true }}
                  transition={{ ease: "easeInOut", duration: 1, delay: 0.05 }}
                ...
                <motion.h1
                  viewport={{ once: true }}
                  transition={{ ease: "easeInOut", duration: 1, delay: 0.15 }}
                  initial={{ opacity: 0, translateY: 100 }}
                  whileInView={{ opacity: 1, translateY: 0 }}
                >
                  Contribute
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, translateY: 0 }}
          >
            Join a groundbreaking network of AI miners, where your compute power
            fuels the future of intelligent infrastructure and earns you passive
            income.
          </motion.p>
      ...
      <section className="common-section features-section flow-hidden">
        <div className="container">
          <motion.h1
            ...
            whileInView={{ opacity: 1, translateX: 0 }}
          >
            <span className="text-gradient light">Features</span>
          </motion.h1>
          <div className="fs-wrap">
            ...
            >
              <p>
                <span className="break">Plug and Play!! </span>Cyborg miners are
                pre loaded with robust software to get you going without any
                installation.
              </p>
            ...
            >
              <p>
                Anybody can mine!! No technical expertise is required to run a
                cyborg miner, you just need a mobile phone or a computer and
            ...
            >
              <p>
                Light and Powerful!! Miners consume only as much power as
                charging your mobile phone. They are small and easy to store.
              </p>
        ...
        <div className="container">
          ...
          <div className="card-wrap">
            ...
            >
              ...
              <div>
                <h5>
                  <span className="text-gradient light">Execution</span> Rewards
                </h5>
                <p>
                  Rent out your miner's compute power to Cyborg and receive{" "}
                  <strong>monthly payouts</strong> in local fiat or crypto.
                  Passive income, on your terms!
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div>
                <h5>
                  <span className="text-gradient light">Uptime</span> Bonus
                </h5>
                <p>
                  Earn <strong>BORG tokens</strong> for maintaining high
                  uptime—even when your miner is idle. Stay online, get
                  rewarded!
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h5>
                  <span className="text-gradient light">Reputation</span> Bonus
                </h5>
                <p>
                  Miners with consistent network activity and a strong track
                  record of executing AI tasks will earn higher reputation ranks
                  on the Cyborg Chain, unlocking multiplier bonuses on their
                  existing BORG rewards.
                </p>
              </div>
            </motion.div>
          </div>
